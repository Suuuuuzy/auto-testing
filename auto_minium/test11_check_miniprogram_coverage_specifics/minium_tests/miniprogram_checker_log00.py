...
class Miniprogram_Checker(base_taint.BaseTaint):
    ...
    def test_all_bubbling_events_via_method_call(self):
        ...
        data_path : str = '/home/bella-xia/suzy-auto-testing/wxml_parser_python/all_outputs/json_event_full_results/wx0bc8123197e70985.json'
        ...
        dump_data_path : str = '/home/bella-xia/suzy-auto-testing/data/_auxiliary_data/wx0bc8123197e70985/wx0bc8123197e70985_via_func.json'
                    ...
                    if 'm_type' in calling_args and self.is_bubbling_event(event_type=calling_args['m_type']) is True:
                        try:
                            ...
                            return_args =  self.hook_wx_methods_with_page_defined_method_call(
                                ...
                                method_args= self.get_params_from_arguments(calling_args)
                            )
    ...
    def skipped_test_all_bubbling_events_via_element(self):
        ...
        querying_wx_methods = ['getUserInfo', 'chooseInvoice', 'saveImageToPhotosAlbum', 
                                    'chooseAddress', 'saveVideoToPhotosAlbum', 'request']
        dump_data_path : str = '/home/bella-xia/suzy-auto-testing/data/_auxiliary_data/wx0bc8123197e70985/wx0bc8123197e70985_via_element.json'

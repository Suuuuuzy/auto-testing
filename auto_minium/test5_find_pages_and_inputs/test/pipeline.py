...
if __name__ == "__main__":
    ...
    # project_path = "/media/data4/jianjia_data4/miniapp_data/WeMinT_dataset/groundtruth/miniprograms"
    ...
    # jianjia's temp test of shutting down and logging
    project_path = "/media/dataj/wechat-devtools-linux/miniprogram-demo"
    all_project_lists = ["pp-test", "weapp-qrcode" ]
    ...
    for project in all_project_lists:
        ...
        logger.info(project)
        # write_to_file(project, 'test_result_log.txt')

              ...
              a(
                {
                  ...
                  initTime: function () {
                    ...
                    if (a) {
                      for (var e in a) {
                        var n =
                          600 - parseInt(t.tool.getSecond(a[e].created_at));
                        a[e].times = n > 0 ? t.formatSeconds(n) : 0;
                      }
                      (t.data.result.data = a),
                  ...
                  evaluationBtn: function (t) {
                    ...
                    a &&
                      wx.navigateTo({
                        url:
                          "/pages/order/order-comment/order-comment?orderId=" +
                          a.id,
                      });
                  },
                  ...
                  formatSeconds: function (t) {
                    ...
                    a > 60 &&
                      ...
                      (a = parseInt(a % 60)),
                      e > 60 &&
                        ((n = parseInt(e / 60)), (e = parseInt(e % 60))));
                    var r = "" + a < 10 ? "0" + parseInt(a) : parseInt(a);
                    return (
                      e > 0 &&
                        (r =
                          (e < 10 ? "0" + parseInt(e) : parseInt(e)) + ":" + r),
                      n > 0 && (r = parseInt(n) + ":" + r),
                      r
                    );
                  },

...
module.exports = /******/ (function (modules) {
  ...
  __webpack_require__.t = function (value, mode) {
    ...
    /******/
    if (mode & 4 && _typeof2(value) === "object" && value && value.__esModule)
      return value;
    /******/
  ...
  /******/ [
      ...
      function sm3(array) {
        ...
        for (var _i3 = 0; _i3 < n; _i3++) {
          ...
          for (var _j = 16; _j < 68; _j++) {
            W[_j] =
              P1(W[_j - 16] ^ W[_j - 9] ^ rotl(W[_j - 3], 15)) ^
              rotl(W[_j - 13], 7) ^
              W[_j - 6];
          }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function doEncrypt(msg, publicKey) {
        ...
        var x2 = _.hexToArray(
          _.leftPad(p.getX().toBigInteger().toRadix(16), 64)
        );
        var y2 = _.hexToArray(
          _.leftPad(p.getY().toBigInteger().toRadix(16), 64)
        );
      ...
      function doDecrypt(encryptData, privateKey) {
        ...
        var c1 = _.getGlobalCurve().decodePointHex(
      ...
      function doSignature(msg, privateKey) {
        var _ref2 =
          ...
          userId = _ref2.userId;
        var hashHex =
          typeof msg === "string" ? _.utf8ToHex(msg) : _.arrayToHex(msg);
        if (hash) {
          // sm3杂凑
      ...
      function sm4(inArray, key, cryptFlag) {
        ...
        if (
          ...
          for (var _i3 = 1; _i3 <= _paddingCount; _i3++) {
            if (outArray[len - _i3] !== _paddingCount)

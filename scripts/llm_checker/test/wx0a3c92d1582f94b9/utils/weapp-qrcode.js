  ...
  (h.prototype = {
    ...
    (l.prototype = {
      ...
      make: function () {
        if (this.typeNumber < 1) {
          ...
          for (t = 1; t < 40; t++) {
            for (
              var e = P.getRSBlocks(t, this.errorCorrectLevel),
                r = new b(),
                o = 0,
                n = 0;
              n < e.length;
            ...
            for (n = 0; n < this.dataList.length; n++) {
              ...
              r.put(i.mode, 4),
                r.put(i.getLength(), A.getLengthInBits(i.mode, t)),
                i.write(r);
            }
    ...
    (l.createData = function (t, e, r) {
      for (var o = P.getRSBlocks(t, e), n = new b(), i = 0; i < r.length; i++) {
        var a = r[i];
        n.put(a.mode, 4),
          n.put(a.getLength(), A.getLengthInBits(a.mode, t)),
          a.write(n);
      }
      var u = 0;
    ...
    var f = {
      ...
      A = {
        ...
        getErrorCorrectPolynomial: function (t) {
          for (var e = new M([1], 0), r = 0; r < t; r++)
            e = e.multiply(new M([1, _.gexp(r)], 0));
          return e;
        },
      ...
      multiply: function (t) {
        for (
          ...
          for (var o = 0; o < t.getLength(); o++)
            e[r + o] ^= _.gexp(_.glog(this.get(r)) + _.glog(t.get(o)));
        return new M(e, 0);
      },
      mod: function (t) {
        if (this.getLength() - t.getLength() < 0) return this;
        for (
          var e = _.glog(this.get(0)) - _.glog(t.get(0)),
    ...
    function (t) {
      (t = (function t() {
        var r,
          ...
          m = !1;
        for (
          "boolean" == typeof g && ((m = g), (g = arguments[1] || {}), (c = 2)),
            (null == g || ("object" !== e(g) && "function" != typeof g)) &&
              (g = {});
          c < d;
          ++c
        )
                ...
                g !== (h = s(r, o)) &&
                  (m && h && (a(h) || (l = i(h)))
                    ? (l
                        ? ((l = !1), (f = n && i(n) ? n : []))
                        : (f = n && a(n) ? n : {}),
                      u(g, { name: o, newValue: t(m, f, h) }))
                    : void 0 !== h && u(g, { name: o, newValue: h }));
        return g;
      })(
        !0,
        {

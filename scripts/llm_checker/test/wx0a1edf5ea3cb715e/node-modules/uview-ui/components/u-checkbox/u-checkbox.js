      ...
      var n = {
          uIcon: function () {
            return i
              ...
              .then(i.bind(null, "b13c"));
          },
        },
        a = function () {
          this.$createElement;
          var e = (this._self._c, this.__get_style([this.checkboxStyle])),
            t = this.__get_style([this.iconStyle]),
            i = this.$u.addUnit(this.labelSize);
          this.$mp.data = Object.assign({}, { $root: { s0: e, s1: t, g0: i } });
        },
        s = [];
    },
    "7c5a": function (e, t, i) {

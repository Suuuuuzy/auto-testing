(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
      ...
      var a = {
        ...
        methods: {
          ...
          chooseItem: function (t, e, i) {
            ...
            var a = [],
              f = [],
              u = JSON.parse(JSON.stringify(o.product)),
              h = 0;
                  ...
                  for (var O = 0; O < u.length; O++) {
                    ...
                    if ("complications" === d)
                      v[d].indexOf(this.choosedFilter[d][p]) >= 0 &&
                        f.indexOf(v.articleRef) < 0 &&
                        (a.push(v), f.push(v.articleRef));
                    else if ("price" === d) {
                      if (
                        "按需报价" === v.price &&
  ...
  [["2ea4", "common/runtime", "common/vendor"]],
]);

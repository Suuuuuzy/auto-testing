...
(0, t.VantComponent)({
  ...
  props: {
    value: {
      type: null,
      observer: function (t) {
        a(t, this.data.currentValue) ||
          this.setData({ currentValue: this.format(t) });
      },
    },
    ...
    max: { type: null, value: Number.MAX_SAFE_INTEGER, observer: "check" },
  ...
  methods: {
    check: function () {
      ...
      a(t, this.data.currentValue) || this.setData({ currentValue: t });
    },
    ...
    onBlur: function (t) {
      ...
      this.emitChange(e),
        this.$emit(
          "blur",
          Object.assign(Object.assign({}, t.detail), { value: e })
        );
    },
    filter: function (t) {
      return (
        (t = String(t).replace(/[^0-9.-]/g, "")),
        this.data.integer && -1 !== t.indexOf(".") && (t = t.split(".")[0]),
        t
      );
    },
    format: function (t) {
      return (
        ...
        (t = Math.max(Math.min(this.data.max, t), this.data.min)),
        (0, e.isDef)(this.data.decimalLength) &&
          (t = t.toFixed(this.data.decimalLength)),
        t
      );
    },
    onInput: function (t) {
      ...
      if ("" !== i) {
        ...
        if ((0, e.isDef)(this.data.decimalLength) && -1 !== s.indexOf(".")) {
          ...
          s = ""
            .concat(n[0], ".")
            .concat(n[1].slice(0, this.data.decimalLength));
        }
        this.emitChange(s);
      }
    },
    emitChange: function (t) {
      this.data.asyncChange || this.setData({ currentValue: t }),
        this.$emit("change", t);
    },
    onChange: function () {
      var t = this.type;
      if (this.isDisabled(t)) this.$emit("overlimit", t);
        ...
        var e,
          a,
          i,
          s = "minus" === t ? -this.data.step : +this.data.step,
          n = this.format(
            ((e = +this.data.currentValue),
            (a = s),
            (i = Math.pow(10, 10)),
            Math.round((e + a) * i) / i)
          );

...
(0, t.VantComponent)({
  ...
  props: {
    ...
    duration: { type: Number, value: 200, observer: "updateChildrenData" },
    direction: { type: String, value: "down", observer: "updateChildrenData" },
    closeOnClickOverlay: {
      type: Boolean,
      value: !0,
  ...
  methods: {
    ...
    toggleItem: function (t) {
      this.children.forEach(function (e, n) {
        ...
        n === t ? e.toggle() : a && e.toggle(!1, { immediate: !0 });
      });
    },
    close: function () {
      this.children.forEach(function (t) {
        t.toggle(!1, { immediate: !0 });
      });
    },
    getChildWrapperStyle: function () {
      ...
      return this.getRect(".van-dropdown-menu").then(function (n) {
        ...
        return (c +=
          "down" === i
            ? "top: ".concat((0, e.addUnit)(u), ";")
            : "bottom: ".concat((0, e.addUnit)(u), ";"));
      });
    },
    onTitleTap: function (t) {
      var e = this,
        a = t.currentTarget.dataset.index;
      this.children[a].data.disabled ||

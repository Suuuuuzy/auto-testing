...
(0, t.VantComponent)({
  ...
  created: function () {
    var t = this,
      ...
      n = e.defaultIndex,
      i = e.initialOptions;
    this.set({ currentIndex: n, options: i }).then(function () {
      t.setIndex(n);
    });
  },
  methods: {
    ...
    adjustIndex: function (t) {
      for (
        var n = this.data, i = this.getCount(), s = (t = (0, e.range)(t, 0, i));
        s < i;
        s++
      )
    ...
    setIndex: function (t, e) {
      ...
      return t !== i.currentIndex
        ? this.set({ offset: s, currentIndex: t }).then(function () {
            e && n.$emit("change", t);
          })
        : this.set({ offset: s });
    },

(0, require("../common/component").VantComponent)({
  ...
  data: { transition: !0, showPopup: !1, showWrapper: !1, displayTitle: "" },
  methods: {
    rerender: function () {
      var e = this;
    ...
    onOptionTap: function (e) {
      var t = e.currentTarget.dataset.option.value,
        r = this.data.value !== t;
      this.setData({ showPopup: !1, value: t }),
        this.$emit("close"),
        this.rerender(),
        r && this.$emit("change", t);
    },
    toggle: function (e) {
      var t = this,
      ...
      "boolean" != typeof e && (e = !n),
        e !== n &&
          (this.setData({ transition: !r.immediate, showPopup: e }),
          e
            ? this.parent.getChildWrapperStyle().then(function (e) {
                t.setData({ wrapperStyle: e, showWrapper: !0 }), t.rerender();
              })
            : this.rerender());
    },
  },

var n = require("../../../@babel/runtime/helpers/defineProperty"),
  ...
  o = require("../mixins/open-type"),
  i = require("../common/color");
(0, e.VantComponent)({
  ...
  props: {
    ...
    confirmButtonColor: { type: String, value: i.RED },
    cancelButtonColor: { type: String, value: i.GRAY },
    showConfirmButton: { type: Boolean, value: !0 },
    overlay: { type: Boolean, value: !0 },
    transition: { type: String, value: "scale" },
  },
  data: { loading: { confirm: !1, cancel: !1 } },
  methods: {
    onConfirm: function () {
    ...
    handleAction: function (e) {
      this.data.asyncClose && this.setData(n({}, "loading.".concat(e), !0)),
        this.onClose(e);
    },
    close: function () {
      this.setData({ show: !1 });
    ...
    onClose: function (n) {
      this.data.asyncClose || this.close(),
        this.$emit("close", n),
        this.$emit(n, { dialog: this });

        ...
        methods: {
          init: function () {
            ...
            t.duration && (this.durationTime = t.duration),
              (this.animation = (0, s.createAnimation)(
              ...
              for (var i in t)
                try {
                  ...
                  if ("object" === (0, o.default)(t[i]))
                    (e = this.animation)[i].apply(e, (0, a.default)(t[i]));
          ...
          styleInit: function (t) {
            var n = this,
              ...
              e = function (t, e) {
                "fade" === e
                  ? (i.opacity = n.animationType(t)[e])
                  : (i.transform += n.animationType(t)[e] + " ");
              };
            return (

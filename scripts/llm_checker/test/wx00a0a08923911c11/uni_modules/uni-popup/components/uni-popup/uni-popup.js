      ...
      (function (t) {
        ...
        i.default = {
          ...
          props: {
            ...
            ismaskShow: { type: Boolean, default: !0 },
          },
          watch: {
            type: {
              handler: function (t) {
            ...
            ismaskShow: {
              handler: function (t) {
                (this.maskShow = t), this.maskShow || this.closeMask();
              },
              immediate: !0,
            },

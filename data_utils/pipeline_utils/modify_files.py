...
from pipeline_utils.modify_app_json import check_borderStyle, check_window_attrs, check_attrs, read_json_file, write_json_file, check_components
import logging
    ...
    for root, dirs, files in os.walk(directory):
        for file in files:
            ...
            if file.endswith('.wxml'):
                ...
                check_components(root, json_data)
